                        ...
                        <tr key={book.bid}>
                            ...
                            <td className='px-5'>
                                <div className='ellipsis'>
                                    <NavLink to={`/books/read/${book.bid}`}>{book.title} <span style={{fontSize:"0.7rem"}}>(리뷰:{book.rcnt}, 좋아요:{book.fcnt})</span></NavLink>
                                </div>
                            </td>
