...
public class AddressHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into address values(null, '홍길동', '010-2020-1010', '인천 서구 서곶로120 루원시티 포레나', '')");
        db.execSQL("insert into address values(null, '강감찬', '010-2020-2020', '서울 강남구 압구정동 현대아파트', '')");
        db.execSQL("insert into address values(null, '심청이', '010-2020-3030', '인천 부평구 계산동 자이아파트', '')");
